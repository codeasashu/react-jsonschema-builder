        ...
        <div className="array-type">
          <Row className="array-item-type" type="flex" justify="space-around" align="middle">
            ...
            <Col span={this.context.isMock ? 4 : 5} className="col-item col-item-desc">
              <Input
                addonAfter={
                  <EditOutlined onClick={() => this.handleShowEdit('description')} />
                }
    ...
    return show ? (
      <div>
        <Row type="flex" justify="left" align="middle">
            ...
            <Col span={1} className="down-style-col">
              {value.type === 'object' && (
                <span className="delete-item"
                  onClick={() => {
                    this.Model.setOpenValueAction({ key: [].concat(prefix, name, 'properties'), value: true });
                    this.Model.addChildFieldAction({ key: [].concat(prefix, name, 'properties') });
                  }}
                >
                  <PlusCircleOutlined />
                </span>
          ...
          <Col span={3} className="col-item col-item-type">
            <FieldSelector value={value} onChange={this.handleChangeType} />
          </Col>
